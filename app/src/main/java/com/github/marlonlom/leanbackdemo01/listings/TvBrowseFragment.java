...
public class TvBrowseFragment extends BrowseFragment {
    ...
    void initialize() {
        ...
        this.setAdapter(mRowsAdapter);
    }

    private void setupUIElements() {
        setBadgeDrawable(ContextCompat.getDrawable(getActivity(), R.drawable.banner01));
        setBrandColor(ContextCompat.getColor(getActivity(), R.color.ld1_primary));
    }
}
